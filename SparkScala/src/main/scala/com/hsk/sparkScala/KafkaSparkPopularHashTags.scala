...
object KafkaSparkPopularHashTags {
  ...
  val conf = new SparkConf().setMaster("local[2]").setAppName("Spark Streaming - Kafka Producer - PopularHashTags").set("spark.executor.memory", "1g")
